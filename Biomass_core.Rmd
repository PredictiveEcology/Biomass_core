...
(ref:Abie-sp) *Abies sp.*

(ref:Pinu-sp) *Pinus sp.*

(ref:Pice-eng) *Picea engelmannii* 

(ref:Pice-gla) *Picea glauca*

(ref:Popu-sp) *Populus sp.*

(ref:Pseud-men) *Pseudotsuga menziesii*
...
Require(c("SpaDES.core", "git2r", "kableExtra", "openxlsx"),
        require = FALSE)
Require("dplyr")
```
...
```{r invariantSpptraits, echo = FALSE, eval = TRUE, message = FALSE}
...
caption <- paste("Example of an invariant species traits table (the",
                 "`species` table object in the module), with species (ref:Abie-sp) (Abie_sp),",
                 "(ref:Pice-eng) (Pice_eng), (ref:Pice-gla) (Pice_gla), (ref:Pinu-sp),",
                 "(Pinu_sp), (ref:Popu-sp) (Popu_sp) and (ref:Pseud-men) (Pseu_men). Note",
                 "that these are theoretical values.")
knitr::kable(tab,
             caption = caption) %>%
...
caption <- paste("Example of a spatio-temporally varying species traits",
                 "table (the `speciesEcoregion` table object in the module), with two ecolocations",
                 "(called `ecoregionGroups`) and species (ref:Abie-sp) (Abie_sp),",
                 "(ref:Pice-eng) (Pice_eng), (ref:Pice-gla) (Pice_gla), (ref:Pinu-sp),",
                 "(Pinu_sp), (ref:Popu-sp) (Popu_sp) and (ref:Pseud-men) (Pseu_men). If a simulation",
                 "runs for 10 year using this table, trait values from year 2 would be used during",
                 "simulation years 2-10.")
knitr::kable(tab,
             caption = caption) %>%
