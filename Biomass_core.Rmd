...
#   opts <- pander::panderOptions("knitr.auto.asis", FALSE)  
#   pander::pander(tab, caption = SpaDES.docs::addLabel(caption), justify = justCols)
#   options(opts)
# } else {
...
justCols <- sapply(tab, function(x) ifelse(is.numeric(x), "right", "left"))
panble(tab, caption, panderArgs = list("justify" = justCols), kableArgs = list(longtable = TRUE))
```
