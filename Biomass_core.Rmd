...
Require(c("SpaDES.core", "git2r", "kableExtra", "openxlsx"), require = FALSE)
Require("dplyr")
```
...
tab <- read.csv(normPath("tables/invariantTraits_example.csv"))
...
tab <- read.csv(normPath("tables/spatiallyVaryingTraits_example.csv"))
...
tab <- read.csv(normPath("tables/minRelativeB_example.csv"))
...
tab <- read.csv(normPath("tables/probGerm_example.csv"))
...
tab$species.shade.tolerance <- as.character(tab$species.shade.tolerance) ## to ensure left-alignment
knitr::kable(tab, caption = caption) %>%
  kableExtra::kable_styling(latex_options = c("repeat_header"))
```
