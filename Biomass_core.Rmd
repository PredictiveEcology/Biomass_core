...
## kable/kableExtra do not work properly. Table is always too wide.
## use pander instead and latex code to make landscape table
...
opts <- panderOptions("knitr.auto.asis", FALSE)   ## to make landscape and escape special characters 
pander(tab, caption = caption, justify = justCols)
options(opts)
```
...
```{r varyingSpptraits, echo = FALSE, eval = TRUE, message = FALSE}
tab <- openxlsx::read.xlsx("tables/exampleTables.xlsx", sheet = "spatially_varyingTraits", 
                           colNames = TRUE, sep.names = " ")
...
knitr::kable(tab, caption = caption, longtable = TRUE) %>%
  kableExtra::kable_styling(latex_options = c("repeat_header"))
```
...
```{r minRelB, echo = FALSE, eval = TRUE, message = FALSE}
tab <- openxlsx::read.xlsx("tables/exampleTables.xlsx", sheet = "minRelativeB", 
                           colNames = TRUE, sep.names = " ")
names(tab)[grep("X", names(tab))] <- ""
...
```{r suffLight, echo = FALSE, eval = TRUE, message = FALSE}
tab <- openxlsx::read.xlsx("tables/exampleTables.xlsx", sheet = "probGerm", 
                           colNames = TRUE, sep.names = " ")
names(tab)[grep("X", names(tab))] <- ""
...
## knitr/kableExtra longtable = TRUE and scale_down do not work together
## knitr/kableExtra longtable = TRUE/latex_table_env = "longtable" and full_width do not work together (as of June 3rd 2022)
## instead, we use pander and latex commands to put the table in a landscape page.
# knitr::kable(df_inputs, caption) %>%
# kable_styling(latex_table_env = "longtable",
# latex_options = c("repeat_header"), full_width = TRUE) %>%
# landscape(.) %>%
...
pander::pander(df_inputs, caption = caption, justify = "left",
...
```{r moduleParams2-Biomass-core, echo = FALSE, eval = FALSE, message = FALSE, results = 'asis'}
...
opts <- panderOptions("knitr.auto.asis", FALSE)    
pander(df_params, caption = caption, justify = "left", 
...
# knitr::kable(df_outputs, caption = caption, longtable = TRUE) %>%
...
pander(df_outputs, caption = caption, justify = "left", 
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table1_Appendix1", 
                           colNames = TRUE, sep.names = " ")
names(tab)[grep("X", names(tab))] <- ""
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table2_Appendix1", 
                           colNames = TRUE, sep.names = " ")
names(tab)[grep("X", names(tab))] <- ""
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table3_Appendix1", 
                           colNames = TRUE, sep.names = " ")
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table4_Appendix1", 
                           colNames = TRUE, sep.names = " ")
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table5_Appendix1", 
                           colNames = TRUE, sep.names = " ")
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table6_Appendix1", 
                           colNames = TRUE, sep.names = " ")
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table7_Appendix1", 
                           colNames = TRUE, sep.names = " ")
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table8_Appendix1", 
                           colNames = TRUE, sep.names = " ")
...
tab <- openxlsx::read.xlsx("tables/LBSE_LandR_comparisonTables.xlsx", sheet = "Table9_Appendix1", 
                           colNames = TRUE, sep.names = " ")
